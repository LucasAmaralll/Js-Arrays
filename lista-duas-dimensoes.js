...
console.log (`A aluna da posição 1 da lista de alunos é: ${
    listaDeAlunosEMedias[0][1] // primeiro informa a posição da lista externa e depois a posição da lista interna
}
A nota dessa aluna é ${listaDeAlunosEMedias[1][1]} 
`);

// esse metódo é chamado de lista de duas dimensões ou matrizes
